...
public class Interactions implements CollisionListener {
    ...
    public Interactions(Sonic sonic,Enemy enemy, Enemy2 enemy2, Enemy3 enemy3, EggMan eggMan) {
        this.sonic = sonic;
        this.enemy = enemy;
        this.enemy2 = enemy2;
        this.enemy3 = enemy3;
    ...
    public void collide(CollisionEvent e) {
        if (e.getOtherBody()==sonic){
            if (e.getReportingBody() instanceof Spike || e.getReportingBody() instanceof Enemy || e.getReportingBody() instanceof Enemy3){
