...
public class Level2 extends GameLevel {
    ...
    public void populate(Game game){
        ...
        bounce.addCollisionListener(new ObjectInteraction(getSonic(),game));
        ...
        for (int i = 0; i<60;i++){
            ...
            pipeStart.addCollisionListener(new ObjectInteraction(getSonic(),game));
            pipeMain.addCollisionListener(new ObjectInteraction(getSonic(),game));
        }
...
//        getEggMan().setPosition(new Vec2(-80,90));
        ...
        for (int i = 0; i < 30; i++) {
            ...
            ring.addCollisionListener(new ObjectInteraction(getSonic(),game));
        }
        //health
        for (int i = 0; i<1;i++){
            health = new Health(this);
            health.setPosition(new Vec2(-200,5));
            health.addCollisionListener(new ObjectInteraction(getSonic(),game));
        }
